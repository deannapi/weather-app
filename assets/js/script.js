...
$(document).ready(function() {
    $(".searchBtn").on('click', function getWeather () {
        ...
        $(".city-history").on('click', `#${cityName}`,function historyWeather () {
            ...
            var apiNew = 'https://api.openweathermap.org/data/2.5/weather?q=' + newCity + '&appid=475f5f6bb734d8c713688458591cd41b';
            var newFore = 'https://api.openweathermap.org/data/2.5/forecast?q=' + newCity + '&appid=475f5f6bb734d8c713688458591cd41b';
            // API for Current Weather
